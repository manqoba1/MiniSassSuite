package com.sifiso.codetribe.minisasslibrary.emailUtil;
...
import com.sifiso.codetribe.minisasslibrary.emailUtil.mailer.GmailSender;
...
public class BackgroundMail {
	...
	BackgroundMailListener mListener;
	boolean processVisibility = true;
	ArrayList<String> attachments = new ArrayList<String>();
	Context mContext;
static String LOG = BackgroundMail.class.getSimpleName();
	public BackgroundMail(Context context) {
		this.mContext = context;
		Log.d(LOG, "############ On start Mail ###########");
		// set default display messages
		this.sendingMessage = "Sending mail...";
		this.sendingMessageSuccess = "Your details was sent successfully.";
	}
	...
	public void setmListener(BackgroundMailListener mListener) {
